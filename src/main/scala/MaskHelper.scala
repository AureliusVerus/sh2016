object  MaskHelper {
  ...
  val GROUP_RELATIVES_MASK = (1 << REL_LOVE) | (1 << REL_SPOUSE) | (1 << REL_PARENT) | (1 << REL_CHILD) |
                            (1 << REL_BROTHER_SISTER) | (1 << REL_UNCLE_AUNT) | (1 << REL_RELATIVE) |
                            (1 << REL_GRANDPARENT) | (1 << REL_GRANDCHILD) | (1 << REL_PARENT_IN_LAW) |
  ...
  def isRelatives(mask: Int) = checkGroup(mask, GROUP_RELATIVES_MASK)
